...
public class Config_35d implements ExperimentConfig {
	...
	public String getDescription() {
		return "Only WS - RAM differentiates - minimal disk IO";
	}
