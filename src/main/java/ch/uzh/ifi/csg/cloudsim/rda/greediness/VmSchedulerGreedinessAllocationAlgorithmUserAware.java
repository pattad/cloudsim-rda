...
public class VmSchedulerGreedinessAllocationAlgorithmUserAware extends
	...
	public VmSchedulerGreedinessAllocationAlgorithmUserAware(
	...
	public Map<String, Float> getUserGreediness(double currentTime, List<Vm> vms) {
